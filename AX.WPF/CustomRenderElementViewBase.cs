...
namespace AX.WPF
{
    public class CustomRenderElementViewBase<ViewModelType> : CustomRenderOverlayElement
        where ViewModelType : INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty ViewModelProperty =
            DependencyProperty.Register(nameof(ViewModel), typeof(ViewModelType), typeof(CustomRenderElementViewBase<ViewModelType>), new PropertyMetadata(null));
        ...
        {
            var element = d as CustomRenderElementViewBase<ViewModelType>;
